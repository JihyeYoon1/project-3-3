						...
						<div class="dialog" id="dialog" style="overflow:auto;">
							<!-- 검색기능 -->
							 <div style="width::50px; margin-top:10px; border-bottom:3px solid #9e9e9e;">
							  <form class="form-inline"name="searchForm" action="/calender" method="get">
							    <input class="form-control ml-auto" style="width: 230px; margin-right:7px;" type="search" name="search_value" id="search_value" placeholder="이름 혹은 전화번호" aria-label="검색">
